...
function CreateProject(props) {
    const {onClickPay, onClickFinish, createProjectWithoutGift, customUploadList, setCustomUploadList, fileList, setFileList, productList, setProductList, setTotalProductNum, startDate, endDate, setStartDate, setEndDate} = props;
    ...
    const [containGift, setContainGift] = useState(false);
    ...
    return (
        <div className='createproject-container'>
            ...
            <div id='select-gift-btn' className='create-project-selectBox' >
                <div className='create-project-card' onClick={addGift}>
            ...
            </div>
            {
                containGift?(
                    ...
                    <button id='create-project-without-gift-btn' className={'btn-bottom-big'} onClick={createProjectWithoutGift}>완료하기</button>
                </>
            }
        </div>
    )
