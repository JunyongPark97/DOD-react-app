...
export default function InvalidPage() {
    ...
    return (
        <div className='result-page-container'>
            ...
            <div id='result-page-invalid-howtoapply' className='result-page-button-container'>
            ...
            <div id='result-page-invalid-aboutdod' className='result-page-button-container'>
                <p className='result-page-button-text'>디오디는 어떤 서비스인가요?</p>
                <img alt='' className='result-page-button-icon' src={process.env.PUBLIC_URL + '/result-arrow.png'}/>
            </div>
            <div id='result-page-invalid-anyother' className='result-page-button-container-violet'>
