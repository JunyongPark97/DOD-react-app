...
function InactiveResultModal(props) {
                    ...
                    <div className='modal-container'>
                        {
                            showResult?(
                                <>
                                    {
                                        win?(<p className='result-modal-title'>기프티콘을 추가하여<br/>링크를 활성화해주세요!</p>):(<></>)
                                    }
                                    {
                                    ...
                                    <div className='result-modal-plz-container' onClick={onClickMore} style={{cursor:'pointer'}}>
                                        <p style={{cursor:'pointer'}} className='result-modal-plz-text'>
...
export default InactiveResultModal
